...
- 6.4 [Étapes avancées](06-framework-agregation/04-etapes-avancees.md)
    - 6.4.1 [$lookup (jointures)](06-framework-agregation/04.01-lookup.md)
    - 6.4.2 [$unwind](06-framework-agregation/04.02-unwind.md)
    - 6.4.3 [$addFields et $set](06-framework-agregation/04.03-addfields-set.md)
    - 6.4.4 [$replaceRoot et $replaceWith](06-framework-agregation/04.04-replaceroot-replacewith.md)
    - 6.4.5 [$facet](06-framework-agregation/04.05-facet.md)
    - 6.4.6 [$bucket et $bucketAuto](06-framework-agregation/04.06-bucket-bucketauto.md)
    - 6.4.7 [$graphLookup](06-framework-agregation/04.07-graphlookup.md)
    - 6.4.8 [$merge et $out](06-framework-agregation/04.08-merge-out.md)
    - 6.4.9 [$redact](06-framework-agregation/04.09-redact.md)
